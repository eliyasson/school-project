...
<header id="header">
  <?php
      require_once 'db.php';
      $banner_get_query = "SELECT banner_title, banner_subtitle, photo_location FROM banners where active_status = 1";
      $banner_from_db = mysqli_query($db_connect, $banner_get_query);
      $after_fetch_assoc_banner = mysqli_fetch_assoc($banner_from_db);
  ?>
  <div class="intro" style="background: url(<?= $after_fetch_assoc_banner['photo_location']?>) center center no-repeat;">
    <div class="overlay">
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 intro-text">
            <h1><?= $after_fetch_assoc_banner['banner_title']?></h1>
            <p><?= $after_fetch_assoc_banner['banner_subtitle']?></p>
...
<div id="services">
  <div class="container">
    ...
    <div class="row">
      ...
      <?php
        $service_get_query = "SELECT * FROM services ORDER BY id DESC LIMIT 0,3";
        $service_from_db = mysqli_query($db_connect, $service_get_query);

        foreach ($service_from_db as $service) {
      ?>
      <div class="col-md-4">
        <div class="service-media"> <img src="<?= $service['service_photo'] ?>" alt=" "> </div>
    ...
    <div class="row">
      <?php
        $service_get_query = "SELECT * FROM services ORDER BY id DESC LIMIT 3,3";
        $service_from_db = mysqli_query($db_connect, $service_get_query);
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <input type="text" id="name" class="form-control" placeholder="Name" required="required" name="guest_name">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <input type="email" id="email" class="form-control" placeholder="Email" required="required" name="guest_email">
                <p class="help-block text-danger"></p>
              </div>
            </div>
          </div>
